        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="inc/img/product/<?php echo $row['Thumbnail']; ?>" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">$<?php echo $row['DiscountPrice']; ?></h3>
                    <p class="mb-4"><?php echo substr($row['Description'],0,300); ?></p>
                    <div class="d-flex mb-3">
                    ...
                    <div class="d-flex pt-2">
                       ...
                       <?php $link =  mysqli_query($db,"SELECT * FROM settings")->fetch_assoc(); ?>
                            <a class="text-dark px-2" href="<?php echo $link['Facebook']; ?>">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a class="text-dark px-2" href="<?php echo $link['Twitter']; ?>">
                                <i class="fab fa-twitter"></i>
                            </a>
                            <a class="text-dark px-2" href="<?php echo $link['Linkedin']; ?>">
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="owl-carousel related-carousel">
                    <?php 
                    $category =  mysqli_query($db,"SELECT * FROM products WHERE ProductCategory ='$ProductCategory'");
